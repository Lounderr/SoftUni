    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            using (SqlConnection connection = new SqlConnection($"Server=.;Integrated Security=true;Database=MinionsDB;"))
            {
                ...
                {
                    string addVillainToDbSql = @"INSERT INTO Villains(Name, EvilnessFactorId) VALUES (@VillainName, (SELECT Id FROM EvilnessFactors WHERE Name = 'evil'));";
